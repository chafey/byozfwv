...
<head>
    <meta charset="utf-8">
    <title>colors/colormap.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">colors/colormap.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const COLOR_BLACK = [0, 0, 0, 255];
