...
<html lang="en">
<head>
    <title>Code coverage report for internal/generateLut.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">internal/</a> generateLut.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">5×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import generateLutNew from './generateLutNew.js';
&nbsp;
/**
...
export default function (image, windowWidth, windowCenter, invert, modalityLUT, voiLUT) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (modalityLUT || voiLUT) {
<span class="cstat-no" title="statement not covered" >    return generateLutNew(image, windowWidth, windowCenter, invert, modalityLUT, voiLUT);</span>
  }
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (image.cachedLut === undefined) {
